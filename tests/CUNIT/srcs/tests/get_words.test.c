...
/*   Updated: 2023/04/27 18:36:31 by rbroque          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_words__test(void)
{
	...
	compare_tok_lst(str10, exp_tok10, 5);
	compare_tok_lst(str11, exp_tok11, 4);
	compare_tok_lst(str12, exp_tok12, 5);
	compare_tok_lst_ptr(str13, exp_tok13, 1);
	compare_tok_lst_ptr(str14, exp_tok14, 1);
	compare_tok_lst(str15, exp_tok15, 3);
	compare_tok_lst(str16, exp_tok16, 3);
	...
	compare_tok_lst(str22, exp_tok22, 8);
}
